...
struct ConstantPowerCrossfade {
    params: Arc<ConstantPowerCrossfadeParams>,
}

impl Default for ConstantPowerCrossfade {
    fn default() -> Self {
        Self {
...
impl Plugin for ConstantPowerCrossfade {
    // metadata
    const NAME: &'static str = "Constant Power Crossfader";
...
impl ClapPlugin for ConstantPowerCrossfade {
    const CLAP_ID: &'static str = "kittycat.homes:constant-power-crossfade";
...
nih_export_clap!(ConstantPowerCrossfade);
